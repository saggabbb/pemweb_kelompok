                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @else
                        <div class="text-center py-10">
                            ...
                            <div class="mt-6">
                                <a href="{{ url('/explore') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    Start Shopping
                                </a>
                            </div>
                        </div>
