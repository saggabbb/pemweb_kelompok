                        ...
                        <!-- Current Image -->
                         @if($product->image)
                            <div class="mt-4">
                                ...
                                <img src="{{ Storage::url($product->image) }}" class="h-20 w-20 rounded object-cover" alt="Product Image">
                            </div>
                        @endif

                        <!-- Image -->
                        <div class="mt-4">
                            <x-input-label for="image" :value="__('New Product Image ' . ($product->image ? '(Optional)' : ''))" />
